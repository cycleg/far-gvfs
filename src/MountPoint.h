...
class MountPoint
{
  ...
  public:
    ...
    /// не рекомендуется, поскольку флаг монтирования, имя ресурса и путь к
    /// точке монтирования впоследствии могут оказаться неактуальными.
    ///
    ...
    /// #m_mountPointPath и #m_shareName сбрасываются, свойство #m_bMounted
