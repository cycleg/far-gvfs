...
class MountPoint
{
  ...
  public:
    ...
    ///
    /// Признак, что ресурс смонтирован в текущем сеансе far2l.
    ///
    /// @return Ресурс смонитрован в текущем сеансе или нет.
    ///
    /// Ресурс считается смонтированным в данном сеансе, если для него
    /// вызывался mount() и он завершился успешно. В том числе, ресурс мог
    /// быть смонтированным другим приложением. В прочих случаях возвращается
    /// false.
    ///
    /// Возвращаемые isMounted() и wasMounted() значения могут не совпадать.
    /// 
    inline bool wasMounted() const { return m_wasMounted; }
    ///
  ...
  private:
    ...
    bool m_wasMounted; ///< True, если для данного ресурса вызывался mount() и
                       ///< он завершился успешно.
};
