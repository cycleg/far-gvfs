...
/// схеме сетевого пароля (SECRET_SCHEMA_COMPAT_NETWORK). Ключом для поиска
/// пароля в коллекции выступают имя пользователя для аутентификации на
